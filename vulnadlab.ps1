#Base Lists 
$Global:HumansNames = @('Afonso', 'Alexandra', 'Alberto', 'Alexandre', 'Alice', 'Alvaro', 'Amelia', 'Andre', 'Angela', 'Antonio', 'Ariana', 'Artur', 'Beatriz', 'Benedita', 'Bernardo', 'Bruno', 'Carla', 'Carlos', 'Carolina', 'Catarina', 'Celina', 'Claudia', 'Cristina', 'Daniel', 'Daniela', 'David', 'Diogo', 'Duarte', 'Eduardo', 'Elisa', 'Elvira', 'Emanuel', 'Emilia', 'Ernesto', 'Estela', 'Eugenio', 'Eva', 'Fabio', 'Fatima', 'Fernanda', 'Fernando', 'Filipe', 'Francisco', 'Gabriel', 'Gabriela', 'Gaspar', 'Gil', 'Goncalo', 'Guilherme', 'Helena', 'Henrique', 'Hugo', 'Ines', 'Irene', 'Isabel', 'Isabela', 'Joana', 'Joao', 'Joaquim', 'Jorge', 'Jose', 'Juliana', 'Julia', 'Julio', 'Leonor', 'Leticia', 'Lidia', 'Ligia', 'Lourenco', 'Luana', 'Luis', 'Luisa', 'Madalena', 'Manuel', 'Manuela', 'Margarida', 'Mariana', 'Mario', 'Marta', 'Matilde', 'Miguel', 'Monica', 'Nadia', 'Nuno', 'Olga', 'Oscar', 'Patricia', 'Paula', 'Pedro', 'Raquel', 'Rita', 'Rodrigo', 'Rosa', 'Rui', 'Salvador', 'Samuel', 'Sandra', 'Sara', 'Sebastiao', 'Sergio', 'Simao', 'Sofia', 'Susana', 'Telma', 'Teresa', 'Tomas', 'Valentina', 'Vasco', 'Vera', 'Vicente', 'Vitoria', 'Vitor', 'Adriana', 'Adriano', 'Agostinho', 'Aida', 'Aldo', 'Alina', 'Alipio', 'Almerinda', 'Americo', 'Ana', 'Anabela', 'Anastacia', 'Angelo', 'Anibal', 'Anita', 'Antonia', 'Armando', 'Arnaldo', 'Aurora', 'Balbina', 'Baltazar', 'Bartolomeu', 'Bento', 'Berta', 'Caetana', 'Caetano', 'Camila', 'Candida', 'Candido', 'Carmo', 'Cesar', 'Cidalia', 'Cipriano', 'Claudio', 'Conceicao', 'Constanca', 'Cristiano', 'Custodia', 'Damiao', 'Debora', 'Delfim', 'Diana', 'Dinis', 'Domingos', 'Dora', 'Dulce', 'Edgar', 'Edite', 'Eduarda', 'Eliana', 'Elisabete', 'Eliseu', 'Ema', 'Emilio', 'Ermelinda', 'Esmeralda', 'Estevao', 'Etelvina', 'Eugenia', 'Eurico', 'Eva', 'Evelina', 'Fausto', 'Filomena', 'Flavio', 'Flor', 'Frederico', 'Genoveva', 'Gertrudes', 'Gilberto', 'Gisela', 'Graciete', 'Gregorio', 'Gustavo', 'Helder', 'Herminia', 'Horacio', 'Hortense', 'Horacio', 'Idalina', 'Ilidio', 'Irina', 'Isaac', 'Ivone', 'Jacinta', 'Joaquina', 'Judite', 'Julieta', 'Jussara', 'Lara', 'Laurinda', 'Lauro', 'Leandro', 'Ligia', 'Lina', 'Lourdes', 'Lucio', 'Mafalda', 'Mara', 'Marcia', 'Marcelino', 'Marco', 'Marcos', 'Marisa', 'Maxima', 'Maximino', 'Melania', 'Micaela', 'Milene', 'Moises', 'Natalia', 'Nelson', 'Nestor', 'Neuza', 'Nicole', 'Nidia', 'Norberto', 'Octavio', 'Odete', 'Olavo', 'Orlando', 'Paloma', 'Pascoal', 'Patricio', 'Paulina', 'Piedade', 'Pilar', 'Quim', 'Raimundo', 'Rebeca', 'Remedios', 'Renato', 'Ricardo', 'Roberto', 'Rodolfo', 'Rosario', 'Rubina', 'Salome', 'Saraiva', 'Sebastiao', 'Selma', 'Silvano', 'Silvio', 'Silvina', 'Tadeu', 'Tania', 'Teodora', 'Teodoro', 'Tobias', 'Ulisses', 'Valdemar', 'Vanda', 'Veronica', 'Violeta', 'Virgilio', 'Wilma', 'Xavier', 'Yara', 'Yolanda', 'Zacarias', 'Zelia', 'Zita', 'Zulmira')
